 ...
 */
/*
public class reservaappdes extends JFrame{
    ...
    public AppDescuento(int i, String title,int width_1, int height_1,int mode){
    ...
    public static class reservaappdescuento {
    }
}
*/